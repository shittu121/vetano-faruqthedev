...
export default function AiButton() {
  ...
  return (
    ...
    >
      <Link href="/preview-video" className="relative flex items-center justify-center gap-2 rounded-full bg-gradient-to-r from-blue-300 via-blue-500 via-40% to-purple-500 px-4 py-2 text-white">
